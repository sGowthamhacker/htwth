                ...
                <div ref={detailContainerRef} className="h-full overflow-y-auto relative scroll-smooth bg-white dark:bg-slate-900">
                    ...
                    {selectedPost ? (
                        <div className="flex flex-col min-h-full">
                            <header className="p-4 sm:p-6 md:p-8 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900">
                                ...
                                <div className="flex flex-wrap items-center gap-3">
                                    ...
                                    {(selectedPost.tags || []).map((tag, index) => (
                                        <span key={`${tag}-${index}`} className="bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-md text-xs font-medium text-slate-600 dark:text-slate-300">
                                            #{tag}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div className="p-4 sm:p-6 md:p-8 w-full max-w-5xl mx-auto border-t border-slate-200 dark:border-slate-800">
                                <div className="prose prose-lg dark:prose-invert max-w-3xl mx-auto break-words overflow-hidden">
