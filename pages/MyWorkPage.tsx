...
const MyWorkPage: React.FC<MyWorkPageProps> = ({ user, allUsers, writeups, blogPosts, profileUserEmail }) => {
  ...
  const socialLinksData = [
    { key: 'twitter', url: sanitizeUrl(social_links?.twitter), icon: <TwitterIcon className="w-5 h-5"/>, color: 'hover:bg-[#1DA1F2]', shadow: 'hover:shadow-[#1DA1F2]/50' },
    { key: 'github', url: sanitizeUrl(social_links?.github), icon: <GithubIcon className="w-5 h-5"/>, color: 'hover:bg-[#333]', shadow: 'hover:shadow-black/50' },
    { key: 'linkedin', url: sanitizeUrl(social_links?.linkedin), icon: <LinkedInIcon className="w-5 h-5"/>, color: 'hover:bg-[#0077b5]', shadow: 'hover:shadow-[#0077b5]/50' },
    { key: 'instagram', url: sanitizeUrl(social_links?.instagram), icon: <InstagramIcon className="w-5 h-5"/>, color: 'hover:bg-pink-600', shadow: 'hover:shadow-pink-600/50' },
    { key: 'email', url: social_links?.email ? sanitizeUrl(`mailto:${social_links.email}`) : null, icon: <MailIcon className="w-5 h-5"/>, color: 'hover:bg-red-500', shadow: 'hover:shadow-red-500/50' },
  ];
