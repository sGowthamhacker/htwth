...
const UserMenu: React.FC<UserMenuProps> = ({ user, onLogout, onRestart, onOpenSettings, position, isClosing }) => {
  ...
  const originClass = 'origin-bottom-left sm:origin-bottom-right';
